...
<body>
	...
	<div class="row container">
		<div class="col s6">
			<h4 style="margin-top: -131px; position: relative;" class="white-text">Novo Usuário</h4>   
		</div>
	</div>
	...
	<div class="row">
		...
		<br>
			<div class="row">
				...
				<input id="loginUsuario" name="loginUsuario" type="text" class="validate">
				<label for="loginUsuario">Login *</label>
				</div>
				<div class="input-field col s6">
				<input id="senhaUsuario" name="senhaUsuario" type="password" class="validate">
			...
			<div class="row">
				...
				<div class="col s3 offset-s2">
					<p>
						<input type="checkbox" name="usuarioAtivo" id="test5" />
