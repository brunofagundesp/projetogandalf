...
<body>
	...
	<div class="row">
		...
		<br>
            <input type="hidden" name="idCategoria" value="<?= $listCat['idCategoria']?>">
			<div class="row">
				<div class="input-field col s6">
				<input id="nomeCategoria" name="nomeCategoria" type="text" class="validate" value="<?= $listCat['nomeCategoria']?>">
				<label for="nomeCategoria">Nome *</label>
				</div>
			</div>
			<div class="row">
				<div class="input-field col s12">
                    <textarea id="descCategoria" class="materialize-textarea" name="descCategoria"><?= $listCat['descCategoria']?></textarea>
                    <label for="descCategoria">Descrição *</label>
				</div>
			</div>
			<br><br>
				<button class="btn waves-effect blue waves-light" type="submit" name="btnAtualizar">Editar
					<i class="material-icons right"></i>
				</button>
				<a href="./cat" class="btn waves-effect white waves-light black-text">Cancelar <i class="fa fa-ban" aria-hidden="true"></i></a>	<br><br>  
			</form>
		</div>
